  ...
  <nav class="bg-white w-full h-16">
    ...
    <div id="mobile-menu" class="sm:hidden">
      <div class="px-2 pt-2 pb-3 space-y-1">
        ...
        <a
          href="#"
          class="hover:bg-blue-900 text-white block px-3 py-2 rounded-md text-base font-medium"
          aria-current="page"
          >Home</a
        >
        <a
          href="#"
          class="text-white hover:bg-blue-900 hover:text-white block px-3 py-2 rounded-md text-base font-medium"
          >Book a Session</a
        >
        <a
          href="#"
